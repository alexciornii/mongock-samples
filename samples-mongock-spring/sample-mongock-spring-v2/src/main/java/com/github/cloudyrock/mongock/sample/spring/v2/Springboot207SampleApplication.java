...
import com.github.cloudyrock.mongock.sample.spring.v2.changesets.ClientChangeLog;
...
public class Springboot207SampleApplication {
    ...
    private static final String SPRING_BOOT_MONGO_DB = "mongock_db_springboot_2_x_x";
